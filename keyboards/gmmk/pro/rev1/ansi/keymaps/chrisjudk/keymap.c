...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [1] = LAYOUT(
        ...
        RGB_TOG, RGB_MOD,  RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, _______, _______, _______, _______, _______, _______, _______,  QK_BOOT,           KC_SCRL,
        _______, RGB_RMOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, _______, _______, _______, _______, _______, _______,           EE_CLR,            _______,
        _______,           _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______,           _______, KC_PGUP,  TG(1),
...
enum LEDS{
    ...
    LED_SLSH,LED_F_ELEVEN,LED_MINS,LED_LBRC,LED_QUOT,LED_RCTL,LED_F_TWELVE,LED_LS_ONE,LED_RS_ONE,LED_PSCR,LED_LS_TWO,LED_RS_TWO,LED_DEL,LED_LS_THREE,LED_RS_THREE,LED_PGUP,
    LED_LS_FOUR,LED_RS_FOUR,LED_EQL,LED_RIGHT,LED_LS_FIVE,LED_RS_FIVE,LED_END,LED_LS_SIX,LED_RS_SIX,LED_BSPC,LED_PGDN,LED_LS_SEVEN,LED_RS_SEVEN,LED_RBRC,LED_RSFT,
